...
For core_commands:            For sub_commands:

FORMAT:                       FORMAT:
run [core_commands]           [sub_command]

The only difference is that for core commands you add "run" but for
sub commands you don't add "run".

Thank your again for installing the tool have fun, HAPPY INVESTIGATING!
VERSION: 1.0
